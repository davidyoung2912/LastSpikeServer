...
Invoke-RestMethod -Uri "$sessionUrl/$sessionId" -Method Delete | Out-Null
Invoke-RestMethod -Uri "$playerUrl/$playerId" -Method Delete | Out-Null
Invoke-RestMethod -Uri "$boardUrl/$boardId" -Method Delete | Out-Null
